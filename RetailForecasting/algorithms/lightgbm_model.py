"""
LightGBM Model
Fast gradient boosting with efficient memory usage
"""
...
class LightGBMModel:
    ...
    def __init__(self, n_estimators=100, max_depth=6, learning_rate=0.1,
                 subsample=0.8, colsample_bytree=0.8, model_path=None):
        self.model = None
        ...
        self.model_path = model_path or "models/algorithms/lightgbm.pkl"
