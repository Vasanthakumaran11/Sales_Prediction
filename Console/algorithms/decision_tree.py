...
class DecisionTreeModel:
    """Decision Tree Model for demand forecasting"""
    
    def __init__(self, max_depth=15, min_samples_split=5, min_samples_leaf=2, model_path=None):
        self.model = None
        ...
        self.model_path = model_path or "models/algorithms/decision_tree.pkl"
        
    def load_data(self, df):
        """Load and prepare data"""
        print("📚 [Decision Tree] Loading data...")
